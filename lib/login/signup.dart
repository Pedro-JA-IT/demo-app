                        ...
                        child: FadeInAnimation(
                            ...
                            child: MaterialButton(
                              onPressed: () async {
                                ...
                                if (user.text.startsWith('0') ||
                                    user.text.startsWith('1') ||
                                    user.text.startsWith('2') ||
                                    user.text.startsWith('3') ||
                                    user.text.startsWith('4') ||
                                    user.text.startsWith('5') ||
                                    user.text.startsWith('6') ||
                                    user.text.startsWith('7') ||
                                    user.text.startsWith('8') ||
                                    user.text.startsWith('9')) {
                                  AwesomeDialog(
                                    context: context,
                                    dialogType: DialogType.error,
